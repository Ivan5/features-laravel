...
Route::post('/host/reservations', [HostReservationController::class, 'create'])->middleware(['auth:sanctum', 'verified']);
Route::delete('/reservations/{reservation}', [HostReservationController::class, 'cancel'])->middleware(['auth:sanctum', 'verified']);
